...
export default function Section0() {
  const integratonImgs = ["/landing/booking.png", "/landing/agoda.png", "/landing/trivago.png"];
  return (
    <div className={style["landing-hero"]} id="hero">
      <div className={style["landing-hero-magic"]}>
        <FadeInSection className={style["landing-hero-left"]} delay={1}>
        ...
        <FadeInSection className={style["landing-hero-right"]} delay={1.9}>
